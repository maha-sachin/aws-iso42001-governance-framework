...
This template supports the governance workflow for responsible AI review, impact assessment, and risk acceptance. It is designed to fit a documented AI governance process aligned to ISO/IEC 42001 and responsible AI practices.
...
- Residual Risk:
- Approval Status: Pending / Approved / Conditional Approval

## 4. Scoring Guidance

- Low: Minimal impact; controls are in place
- Medium: Some impact or moderate governance gaps
- High: Significant impact on individuals, compliance, or safety
- Critical: Severe risk, potential harm, or regulatory exposure
